...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    var textPixels = ((config.textSize*radius/2)-30);
    ...
    var text2 = fillCircleGroup.append("text")
        ...
        .attr('transform','translate('+radius+','+(textRiseScaleY(config.textVertPosition)+10)+')');
    ...
    //desenhando as bocas
    //boca 1    
    var bocatrieste1 = d3.svg.arc()
        .startAngle(gaugeCircleX(0))
        .endAngle(gaugeCircleX(0.5))
        .outerRadius(gaugeCircleY(radius-80))
        .innerRadius(gaugeCircleY(radius-circleThickness-50));
    d3.select("#elementofillgauge2").append("path")
        .attr("d", bocatrieste1)
        .style("fill", "#FF0000")
        .attr('transform','translate('+(radius)+','+(radius+30)+') rotate(270)');

    //boca 2   
    var bocatrieste2 = d3.svg.arc()
        .startAngle(gaugeCircleX(0))
        .endAngle(gaugeCircleX(0.5))
        .outerRadius(gaugeCircleY(radius-90))
        .innerRadius(gaugeCircleY(radius-circleThickness-65));
    d3.select("#elementofillgauge3").append("path")
        .attr("d", bocatrieste2)
        .style("fill", "#FF6600")
        .attr('transform','translate('+(radius)+','+(radius+30)+') rotate(270)');
    
    //boca 3
    d3.select("#elementofillgauge4").append("rect")
     .attr("x", 10)
     .attr("y", 10)
     .attr("width", 100)
     .attr("height", 5)
   ...
   //boca 4  
    var bocaalegre1 = d3.svg.arc()
        .startAngle(gaugeCircleX(0))
        .endAngle(gaugeCircleX(0.5))
        .outerRadius(gaugeCircleY(radius-90))
        .innerRadius(gaugeCircleY(radius-circleThickness-65));
    d3.select("#elementofillgauge5").append("path")
        .attr("d", bocaalegre1)
        .style("fill", "#248f24")
        .attr('transform','translate('+(radius)+','+(radius+20)+') rotate(90)');

   //boca 5    
    var bocaalegre2 = d3.svg.arc()
        .startAngle(gaugeCircleX(0))
        .endAngle(gaugeCircleX(0.5))
        .outerRadius(gaugeCircleY(radius-80))
        .innerRadius(gaugeCircleY(radius-circleThickness-50));
    d3.select("#elementofillgauge6").append("path")
        .attr("d", bocaalegre2)
        .style("fill", "#00cc44")
        .attr('transform','translate('+(radius)+','+(radius+5)+') rotate(90)');


    // olho esquerdo
    var gaugeCircleArc2 = d3.svg.arc()
        .startAngle(gaugeCircleX(0))
        .endAngle(gaugeCircleX(1))
        .outerRadius(gaugeCircleY(radius-90))
        .innerRadius(gaugeCircleY(radius-circleThickness-80));
    gaugeGroup.append("path")
        .attr("d", gaugeCircleArc2)
        .style("fill", config.circleColor)
        .attr('transform','translate('+(radius-30)+','+(radius-35)+')');

    // olho direito
    var gaugeCircleArc3 = d3.svg.arc()
        .startAngle(gaugeCircleX(0))
        .endAngle(gaugeCircleX(1))
        .outerRadius(gaugeCircleY(radius-90))
        .innerRadius(gaugeCircleY(radius-circleThickness-80));
